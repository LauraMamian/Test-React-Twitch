...
export default function Navlinks() {
    ...
    return (
        <nav className='animate__animated animate__slideInRight md:animate-none z-10 bg-transparent w-full pt-16 min-h-full fixed top-0 left-0 flex justify-center md:pt-0 md:flex md:justify-center md:items-center md:z-auto md:relative md:h-full'>
